...
export const CYCLING_COURSES: CyclingCourse[] = [
  {
    id: 'coastal',
    name: '日本海あおば風街道',
    subName: '海のブルーと鳥海山の山容を仰ぐ快走路',
    type: 'coastal',
    distance: 42.5,
    climb: 210,
    estimatedTime: '約2.5時間',
    difficulty: 'easy',
    description: '日本海のさわやかな潮風を浴びながら、平坦基調の海岸線を走るルート。遮るもののない広大な日本海の水平線と、右手に見上げる荘厳な鳥海山のコントラストが圧巻です。初心者やファミリーにも非常におすすめ。',
    poem: 'ザザーン、ウミネコの唄。潮風が背中をそっと押す。ペダルが波打際を滑るように進み、鳥海山の白雪が青空に映える。',
  ...
  },
  {
    ...
    difficulty: 'hard',
    description: '海抜ほぼ0mのにかほ市・由利本荘市から、鳥海ブルーラインを一気に出羽の鳥海山5合目（鉾立展望台・標高1,150m）まで駆け上がる、全国のクライマー垂涎の超絶景ヒルクライム。ブナの原生林を抜け天空へ。',
...
export const HOSPITALITY_SPOTS: HospitalitySpot[] = [
  {
    ...
    category: 'water',
    area: 'chokai',
    description: '鳥海山の雪解け伏流水が滾々と湧き出る名水百選。サイクリスト用のボトルをキンキンに冷やすことができ、そのまま喉を潤せます。地元有志が常に清掃しています。',
...
export const INITIAL_SUPPORTERS: CampaignSupport[] = [
  {
    ...
    name: '本荘チャリンコ愛好会（佐藤）',
    area: '由利本荘市本荘',
    message: 'にかほ市と由利本荘市の垣根を越えたサイクリングロード、本当に待ち望んでいました！鳥海山をぐるっと周回できる日が待ち遠しい。応援しています！',
